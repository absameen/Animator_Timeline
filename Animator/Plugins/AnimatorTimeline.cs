...
public class AnimatorTimeline : MonoBehaviour {
	...
	private static MethodInfo cachedInvoker = null;
	private static MethodInfo invoker{
		get {
			if(cachedInvoker == null) {
				cachedInvoker = aData.GetType().GetMethod("Invoker");	
			}
	...
	public static bool isPlaying {
		get {
			return (bool)invoker.Invoke(aData, new object[]{new object[]{0}});
		}
		set {
	...
	public static bool isPaused {
		get {
			return (bool)invoker.Invoke(aData, new object[]{new object[]{12}});
		}
		set {
	...
	public static string nowPlayingTake {
		get {
			return (string)invoker.Invoke(aData, new object[]{new object[]{1}});
		}
		set {
	...
	public static float runningTime {
		get {
			return (float)invoker.Invoke(aData, new object[]{new object[]{10}});
		}
		set {
	...
	public static float totalTime {
		get {
			return (float)invoker.Invoke(aData, new object[]{new object[]{11}});
		}
		set {
	...
	public static void Play(string takeName, bool loop = false) {
		if(aData) invoker.Invoke(aData, new object[]{new object[]{2,takeName,loop}});
	}
	
	// stop player
	public static void Stop() {
		
		if(aData) invoker.Invoke(aData, new object[]{new object[]{3}});
		//AMTween.Stop();
	}
	
	// pause player
	public static void Pause() {
		if(aData) invoker.Invoke(aData, new object[]{new object[]{4}});
	}
	
	// resume player
	public static void Resume() {
		if(aData) invoker.Invoke(aData, new object[]{new object[]{5}});
	}
	
	// play take by name from time
	public static void PlayFromTime(string takeName, float time, bool loop = false) {
		if(aData) invoker.Invoke(aData, new object[]{new object[]{6,takeName,time,loop}});
	}
	
	// play take by name from frame
	public static void PlayFromFrame(string takeName, int frame, bool loop = false) {
		if(aData) invoker.Invoke(aData, new object[]{new object[]{7,takeName,frame,loop}});
	}
	
	// preview a single frame (used for scrubbing)
	public static void PreviewFrame(string takeName, float frame) {
		if(aData) invoker.Invoke(aData, new object[]{new object[]{8,takeName,frame}});
	}
	
	// preview a single time (used for scrubbing)
	public static void PreviewTime(string takeName, float time) {
		if(aData) invoker.Invoke(aData, new object[]{new object[]{9,takeName,time}});
	}
	#endregion
	...
	public static void ParseJSONString(string json) {
		JSONTake j = JsonReader.Deserialize<JSONTake>(json);
